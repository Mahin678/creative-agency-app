								...
								>
									<div className="form-group ">
										<input
											required
											defaultValue={
												loggedUser.name || loggedInUser.name
											}
									...
									<div className="form-group">
										<input
											required
											value={loggedUser.email || loggedInUser.email}
											className="form-control p-4"
											name="email"
											ref={register({ required: true })}
										/>
									...
									<div className="d-flex">
										...
										<div className="form-group w-50 ">
											<label
												...
												className="custom-file-upload w-75 p-2 text-center"
											>
												<input
													name="file"
													style={{ display: 'none' }}
									...
									<p className={`${!isValue && 'text-danger'}`}>
										{' '}
										Image is not set , you must be added image{' '}
									</p>
